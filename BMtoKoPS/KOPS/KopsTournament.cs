  ...
  public class KopsTournament : Tournament {
    ...
    */
    ...
    public override void ReadResults() {
      BinaryReader fRes = readerFactory.GetBinaryReader(path, "ZAP");
      ...
      try {
        BinaryReader fDeal = readerFactory.GetBinaryReader(path, "KNT");
    ...
    private void ReadPlayersNames() {
      TextReader f = readerFactory.GetTextReader(path, "LUC");
    ...
    private void ReadSessionName() {
      ...
      try {
        TextReader f = readerFactory.GetTextReader(path, "NAG");
    ...
    private Nullable<int> ReadINR() {
      try {
        TextReader reader = readerFactory.GetTextReader(path, "INR");
    ...
    private void ReadPBN() {
      ...
      try {
        TextReader fRes = readerFactory.GetTextReader(path, "PBN");
        String line;
